...
void GBitset::pageStringDetector(vector<stringOCR>&strArray_){
...
/////////                                                              /////////
			  ...
			  // коэффициент формы страници // *DeltaKh/100;
...
cout<<"@4_2_3";
		   ...
		   // Подпрограмма для получения координат вертикальных колонок в пределах разворота.
				   GrafT[11][0]=0;  GrafT[11][3]=0;  GrafT[11][4]=0;  ////
cout<<"@4_2_4";
	              PageSegmentation();
...
*/
cout<<"@4_2_9";	
			 //Запуск подпрограммы нормализации strArray с учетом величины бордюра
			 data_normalisation();
	         stringNormalisation();
