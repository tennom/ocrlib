...
// Подпрограмма управления последовательностью выполнения всех подпрограмм.
  ...
  void pageStringDetector(vector<stringOCR>&strArray_);
...
//  void PredvCorrectLetH();
  ...
  /// Запуск программы получения координат пряямоугольников вокруг точек
...
// Подпрограмма распознования точек в пределах строки.
// Текущая работа.
