		    ...
		    //
						...
						*/ 
		                ...
		                GBitmap *line=GBitmap::createRegion(inputBitmap, 
															0, 
															strArray[0][index].y0-yLimit0*0.8, 
															inputBitmap->columns(), 
															strArray[0][index].y1-strArray[0][index].y0+yLimit0+yLimit1
		                                                    );
		                
		                scale=lineOCRScaleDetector(line,yLimit0, yLimit1,scale); cout<<"@@@ scale="<<scale<<endl;
		                maxScale=scale; 
